...
#define HOMING_BUMP_MM      { 0, 0, 0, 0, 0, 0, 0, 0}       // (linear=mm, rotational=°) Backoff from endstops after first bump
...
#define AXIS_RELATIVE_MODES { true,true,true,true,true,true,true,true}
 ...
 */
  ...
  #define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define Z_STALL_SENSITIVITY  115
